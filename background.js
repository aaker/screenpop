          ...
          ({
            ...
            success: function (data){
              ...
              {   
                ...
                zendeskMesg.push({title:"Name",message:data.results[0].name});
                zendeskMesg.push({title:"Company",message:data.results[0].user_fields.organization});
                zendeskMesg.push({title:"Email",message:data.results[0].email});
                zendeskMesg.push({title:"Time Zone",message:data.results[0].time_zone});
...
chrome.notifications.onButtonClicked.addListener(function(notifId, btnIdx) {
    ...
    chrome.storage.sync.get({
      ...
      var args = {object: "call",action:"answer","callid":localStorage.callid,"uid":items.ns_username,"destination":mydevice};
      netsapiens.api.post(args, function(){});
            ...
            console.log("Reject");
            var mydevice = "sip:"+items.ns_username;
      var args = {object: "call",action:"reject","callid":localStorage.callid,"uid":items.ns_username};
      netsapiens.api.post(args, function(){});
    ...
    chrome.storage.sync.get({
      ...
      ns_password: ""
        ...
        if (items.ns_server!="" && items.ns_username!="")
        {
          ...
          configuration = {
            "clientName": "NetSapiens Chrome Extension", // A name for the application
            "clientId": "aaker",
            "clientSecret": "693fb6a2391534377194870a0567ca19", // ***OPTIONAL*** can be proxied by api server side
          ...
          setTimeout(function(){
            ...
            var args = {object: "device",action:"read","uid":items.ns_username,"device":mydevice,"format":'json'};
            netsapiens.api.post(args, function(device_read){
              ...
              else
              {
                  ...
                  args = {object: "device",action:"create","uid":items.ns_username,"device":mydevice,"authentication_key":pass};
                  netsapiens.api.post(args, function(device_read){
